...
function E(e, t = void 0, ...n) {
  return Pe(e) ? t ? e.bind(t)(...n) : e(...n) : e;
}
function rr(e = {}) {
...
function ae(e) {
  return Object.fromEntries(
    // @ts-ignore
    Object.entries(e).filter(([t, n]) => t === "attrs" && rr(n) ? !1 : n != null)
  );
}
function or(e, t) {
  var n;
  const r = _e(e), { nodeExtensions: s, markExtensions: o } = vt(e), i = (n = s.find((l) => S(l, "topNode"))) === null || n === void 0 ? void 0 : n.name, a = Object.fromEntries(s.map((l) => {
...
function Ut(e, t) {
  const n = en.fromSchema(t).serializeFragment(e), s = document.implementation.createHTMLDocument().createElement("div");
  ...
  const { editor: t, rules: n } = e, r = new H({
    state: {
      ...
      apply(s, o, i) {
        ...
        return !!c && setTimeout(() => {
          let { text: u } = c;
          typeof u == "string" ? u = u : u = Ut(V.from(u), i.schema);
...
function fr(e) {
  ...
  return n.map((u) => new H({
    ...
    appendTransaction: (d, p, h) => {
      ...
      if (M) {
        let { text: w } = y;
        typeof w == "string" ? w = w : w = Ut(V.from(w), h.schema);
        const { from: k } = y, T = k + w.length, x = hr(w);
        return c({
          rule: u,
          state: h,
          from: k,
...
class Z {
  constructor(t, n) {
    this.splittableMarks = [], this.editor = n, this.extensions = Z.resolve(t), this.schema = or(this.extensions, n), this.setupExtensions();
  }
  /**
   ...
   */
  static resolve(t) {
    const n = Z.sort(Z.flatten(t)), r = mr(n.map((s) => s.name));
  ...
  get plugins() {
    const { editor: t } = this, n = Z.sort([...this.extensions].reverse()), r = [], s = [], o = n.map((i) => {
      ...
      le(i, t.options.enableInputRules) && p && r.push(...p());
      const h = S(i, "addPasteRules", a);
      le(i, t.options.enablePasteRules) && h && s.push(...h());
...
const gr = P.create({
      ...
      new H({
        ...
        props: {
          clipboardTextSerializer: () => {
            const { editor: e } = this, { state: t, schema: n } = e, { doc: r, selection: s } = t, { ranges: o } = s, i = Math.min(...o.map((u) => u.$from.pos)), a = Math.max(...o.map((u) => u.$to.pos)), c = $e(n);
            return He(r, { from: i, to: a }, {
...
}), yr = () => ({ editor: e, view: t }) => (requestAnimationFrame(() => {
  var n;
  e.isDestroyed || (t.dom.blur(), (n = window == null ? void 0 : window.getSelection()) === null || n === void 0 || n.removeAllRanges());
}), !0), vr = (e = !1) => ({ commands: t }) => t.setContent("", e), br = () => ({ state: e, tr: t, dispatch: n }) => {
...
}, Mr = (e) => (t) => e(t), Sr = () => ({ state: e, dispatch: t }) => Cn(e, t), kr = (e, t) => ({ editor: n, tr: r }) => {
  ...
  return !1;
}, Tr = (e) => ({ tr: t, dispatch: n }) => {
  const { from: r, to: s } = e;
  return n && t.delete(r, s), !0;
}, Cr = () => ({ state: e, dispatch: t }) => Tn(e, t), xr = () => ({ commands: e }) => e.keyboardShortcut("Enter"), Ar = () => ({ state: e, dispatch: t }) => En(e, t);
...
function Gt(e, t, n) {
  ...
  for (; i > 0 && ce([...e.parent.child(i - 1).marks], t, n); )
    i -= 1, a -= e.parent.child(i).nodeSize;
  for (; c < e.parent.childCount && ce([...e.parent.child(c).marks], t, n); )
...
const Or = (e, t = {}) => ({ tr: n, state: r, dispatch: s }) => {
...
const _r = (e = null, t = {}) => ({ editor: n, view: r, tr: s, dispatch: o }) => {
  t = {
    scrollIntoView: !0,
    ...t
  };
  const i = () => {
    (St() || Ne()) && r.dom.focus(), requestAnimationFrame(() => {
  ...
  if (o && e === null && !Jt(n.state.selection))
    return i(), !0;
  const a = De(s.doc, e) || n.state.selection, c = n.state.selection.eq(a);
  return o && (c || s.setSelection(a), c && s.storedMarks && s.setStoredMarks(s.storedMarks), i()), !0;
}, Pr = (e, t) => (n) => e.every((r, s) => t(r, { ...n, index: s })), Rr = (e, t) => ({ tr: n, commands: r }) => r.insertContentAt({ from: n.selection.from, to: n.selection.to }, e, t), Be = (e) => {
  const t = e.childNodes;
  for (let n = t.length - 1; n >= 0; n -= 1) {
    const r = t[n];
    r.nodeType === 3 && r.nodeValue && /^(\n\s\s|\n)$/.test(r.nodeValue) ? e.removeChild(r) : r.nodeType === 1 && Be(r);
  }
  return e;
};
function lt(e) {
...
function mt(e, t, n) {
  if (e instanceof nn || e instanceof V)
    return e;
  n = {
    slice: !0,
    parseOptions: {},
...
function Hr(e, t, n) {
  ...
  if (r < t)
    return;
  const s = e.steps[r];
  if (!(s instanceof An || s instanceof On))
    return;
...
const $r = (e) => !("type" in e), Ir = (e, t, n) => ({ tr: r, dispatch: s, editor: o }) => {
  var i;
  if (s) {
    n = {
    ...
    n.updateSelection && Hr(r, r.steps.length - 1, -1), n.applyInputRules && r.setMeta("applyInputRules", { from: c, text: h }), n.applyPasteRules && r.setMeta("applyPasteRules", { from: c, text: h });
  }
  return !0;
}, Dr = () => ({ state: e, dispatch: t }) => vn(e, t), Nr = () => ({ state: e, dispatch: t }) => kn(e, t), Br = () => ({ state: e, dispatch: t }) => wn(e, t), jr = () => ({ state: e, dispatch: t }) => Sn(e, t), Fr = () => ({ state: e, dispatch: t, tr: n }) => {
  try {
    const r = Te(e.doc, e.selection.$from.pos, -1);
    return r == null ? !1 : (n.join(r, 2), t && t(n), !0);
  } catch {
    return !1;
  }
}, zr = () => ({ state: e, dispatch: t, tr: n }) => {
  try {
    const r = Te(e.doc, e.selection.$from.pos, 1);
    return r == null ? !1 : (n.join(r, 2), t && t(n), !0);
  } catch {
...
}, Vr = () => ({ state: e, dispatch: t }) => Mn(e, t), Wr = () => ({ state: e, dispatch: t }) => bn(e, t);
function je() {
...
const Ur = (e) => ({ editor: t, view: n, tr: r, dispatch: s }) => {
  const o = Kr(e).split(/-(?!$)/), i = o.find((l) => !["Alt", "Ctrl", "Meta", "Shift"].includes(l)), a = new KeyboardEvent("keydown", {
    key: i === "Space" ? " " : i,
...
const qr = (e, t = {}) => ({ state: n, dispatch: r }) => {
  const s = R(e, n.schema);
  return st(n, s, t) ? yn(n, r) : !1;
}, Gr = () => ({ state: e, dispatch: t }) => gn(e, t), Jr = (e) => ({ state: t, dispatch: n }) => {
  const r = R(e, t.schema);
  return mn(r)(t, n);
}, Yr = () => ({ state: e, dispatch: t }) => fn(e, t);
function kt(e, t) {
...
const Xr = (e, t) => ({ tr: n, state: r, dispatch: s }) => {
  ...
  return a ? (a === "node" && (o = R(e, r.schema)), a === "mark" && (i = K(e, r.schema)), s && n.selection.ranges.forEach((c) => {
    r.doc.nodesBetween(c.$from.pos, c.$to.pos, (l, u) => {
      o && o === l.type && n.setNodeMarkup(u, void 0, de(l.attrs, t)), i && l.marks.length && l.marks.forEach((d) => {
        i === d.type && n.addMark(u, u + l.nodeSize, i.create(de(d.attrs, t)));
      });
    });
  }), !0) : !1;
}, Qr = () => ({ tr: e, dispatch: t }) => (t && e.scrollIntoView(), !0), Zr = () => ({ tr: e, dispatch: t }) => {
  if (t) {
    const n = new hn(e.doc);
    e.setSelection(n);
  }
  return !0;
}, ts = () => ({ state: e, dispatch: t }) => pn(e, t), es = () => ({ state: e, dispatch: t }) => un(e, t), ns = () => ({ state: e, dispatch: t }) => dn(e, t), rs = () => ({ state: e, dispatch: t }) => cn(e, t), ss = () => ({ state: e, dispatch: t }) => ln(e, t);
function $t(e, t, n = {}, r = {}) {
  return mt(e, t, {
    slice: !1,
    parseOptions: n,
...
const os = (e, t = !1, n = {}, r = {}) => ({ editor: s, tr: o, dispatch: i, commands: a }) => {
  var c, l;
  const { doc: u } = o;
  if (n.preserveWhitespace !== "full") {
    const d = $t(e, s.schema, n, {
...
function Ve(e, t) {
  ...
  return n === "node" ? ds(e, t) : n === "mark" ? Fe(e, t) : {};
}
function us(e, t = JSON.stringify) {
  const n = {};
  return e.filter((r) => {
    const s = t(r);
...
const ys = (e, t = {}) => ({ tr: n, state: r, dispatch: s }) => {
  ...
  return gs(r, n, c);
}, vs = (e, t) => ({ tr: n }) => (n.setMeta(e, t), !0), bs = (e, t = {}) => ({ state: n, dispatch: r, chain: s }) => {
  const o = R(e, n.schema);
  let i;
  return n.selection.$anchor.sameParent(n.selection.$head) && (i = n.selection.$anchor.parent.attrs), o.isTextblock ? s().command(({ commands: a }) => te(o, { ...i, ...t })(n) ? !0 : a.clearNodes()).command(({ state: a }) => te(o, { ...i, ...t })(a, r)).run() : (console.warn('[tiptap warn]: Currently "setNode()" only supports text block nodes.'), !1);
}, Ms = (e) => ({ tr: t, dispatch: n }) => {
  if (n) {
    const { doc: r } = t, s = F(e, 0, r.content.size), o = tt.create(r, s);
    t.setSelection(o);
  }
  return !0;
}, Ss = (e) => ({ tr: t, dispatch: n }) => {
  if (n) {
...
const ws = ({ keepMarks: e = !0 } = {}) => ({ tr: t, state: n, dispatch: r, editor: s }) => {
  ...
  if (o instanceof tt && o.node.isBlock)
    return !a.parentOffset || !dt(i, a.pos) ? !1 : (r && (e && pe(n, s.extensionManager.splittableMarks), t.split(a.pos).scrollIntoView()), !0);
  if (!a.parent.isBlock)
    return !1;
  const d = c.parentOffset === c.parent.content.size, p = a.depth === 0 ? void 0 : as(a.node(-1).contentMatchAt(a.indexAfter(-1)));
  let h = d && p ? [
    {
      type: p,
      attrs: u
  ...
  if (!h && !m && dt(t.doc, t.mapping.map(a.pos), 1, p ? [{ type: p }] : void 0) && (m = !0, h = p ? [
    ...
    e && pe(n, s.extensionManager.splittableMarks), t.scrollIntoView();
  }
  return m;
}, Es = (e, t = {}) => ({ tr: n, state: r, dispatch: s, editor: o }) => {
  var i;
  ...
  if (c.parent.content.size === 0 && c.node(-1).childCount === c.indexAfter(-1)) {
    ...
    if (s) {
      ...
      n.replace(k, c.after(-v), new on(y, 4 - M, 0));
      let T = -1;
      n.doc.nodesBetween(k, n.doc.content.size, (x, L) => {
        if (T > -1)
          return !1;
        x.isTextblock && x.content.size === 0 && (T = L + 1);
  ...
  const n = Yt((i) => i.type === t)(e.selection);
  if (!n)
    return !0;
  ...
  return n.node.type === (s == null ? void 0 : s.type) && zt(e.doc, n.pos) && e.join(n.pos), !0;
}, Lt = (e, t) => {
  const n = Yt((i) => i.type === t)(e.selection);
  if (!n)
    return !0;
  ...
  if (r === void 0)
    return !0;
  const s = e.doc.nodeAt(r);
  return n.node.type === (s == null ? void 0 : s.type) && zt(e.doc, r) && e.join(r), !0;
}, Ts = (e, t, n, r = {}) => ({ editor: s, tr: o, state: i, dispatch: a, chain: c, commands: l, can: u }) => {
  ...
  if (!v)
    return !1;
  const w = Yt((k) => ue(k.type.name, d))(f);
  if (v.depth >= 1 && w && v.depth - w.depth <= 1) {
    if (w.node.type === h)
      return l.liftListItem(m);
    if (ue(w.node.type.name, d) && h.validContent(w.node.content) && a)
...
}, As = (e, t = {}) => ({ state: n, commands: r }) => {
  const s = R(e, n.schema);
  return st(n, s, t) ? r.lift(s) : r.wrapIn(s, t);
}, Os = () => ({ state: e, dispatch: t }) => {
  const n = e.plugins;
  for (let r = 0; r < n.length; r += 1) {
    const s = n[r];
    let o;
...
}, _s = (e, t = {}) => ({ tr: n, state: r, dispatch: s }) => {
  var o;
  ...
  if (u && i) {
    let { from: p, to: h } = a;
    const m = (o = l.marks().find((g) => g.type === c)) === null || o === void 0 ? void 0 : o.attrs, f = Gt(l, c, m);
...
}, Ps = (e, t = {}) => ({ tr: n, state: r, dispatch: s }) => {
  let o = null, i = null;
  const a = kt(typeof e == "string" ? e : e.name, r.schema);
  return a ? (a === "node" && (o = R(e, r.schema)), a === "mark" && (i = K(e, r.schema)), s && n.selection.ranges.forEach((c) => {
...
}, Rs = (e, t = {}) => ({ state: n, dispatch: r }) => {
  const s = R(e, n.schema);
  return sn(s, t)(n, r);
}, Hs = (e, t = {}) => ({ state: n, dispatch: r }) => {
  const s = R(e, n.schema);
  return rn(s, t)(n, r);
};
var $s = /* @__PURE__ */ Object.freeze({
  ...
  clearNodes: br,
  command: Mr,
  createParagraphNear: Sr,
  cut: kr,
  deleteCurrentNode: wr,
  deleteNode: Er,
  deleteRange: Tr,
  deleteSelection: Cr,
  enter: xr,
  ...
  joinItemBackward: Fr,
  joinItemForward: zr,
  joinTextblockBackward: Vr,
  joinTextblockForward: Wr,
  joinUp: Dr,
  keyboardShortcut: Ur,
  lift: qr,
  liftEmptyBlock: Gr,
  ...
  selectNodeForward: es,
  selectParentNode: ns,
  selectTextblockEnd: rs,
  selectTextblockStart: ss,
  setContent: os,
  setMark: ys,
  setMeta: vs,
  setNode: bs,
...
const Is = P.create({
  ...
  addKeyboardShortcuts() {
    const e = () => this.editor.commands.first(({ commands: i }) => [
      ...
      () => i.command(({ tr: a }) => {
        const { selection: c, doc: l } = a, { empty: u, $anchor: d } = c, { pos: p, parent: h } = d, m = d.parent.isTextblock && p > 0 ? a.doc.resolve(p - 1) : d, f = m.parent.type.spec.isolating, g = d.pos - d.parentOffset, y = f && m.parent.childCount === 1 ? g === d.pos : G.atStart(l).from === p;
    ...
    return [
      ...
      new H({
        ...
        appendTransaction: (e, t, n) => {
          ...
          if (!r || s)
            return;
          const { empty: o, from: i, to: a } = t.selection, c = G.atStart(t.doc).from, l = G.atEnd(t.doc).to;
...
class Us extends nr {
   ...
   */
  registerPlugin(t, n) {
    const r = Pe(n) ? n(t, [...this.state.plugins]) : [...this.state.plugins, t], s = this.state.reconfigure({ plugins: r });
  ...
  createView() {
    ...
    let n;
    try {
      n = $t(this.options.content, this.schema, this.options.parseOptions, { errorOnInvalidContent: this.options.enableContentCheck });
    } catch (i) {
    ...
    const r = De(n, this.options.autofocus);
    this.view = new Qe(this.options.element, {
  ...
  return new bt({
    ...
    handler: ({ state: t, range: n, match: r }) => {
      ...
      if (i) {
        ...
        if (Xt(n.from, n.to, t.doc).filter((h) => h.mark.type.excluded.find((f) => f === e.type && f !== h.mark.type)).filter((h) => h.to > l).length)
          return null;
...
function et(e) {
  return new bt({
    ...
    handler: ({ state: t, range: n, match: r, chain: s }) => {
      const o = E(e.getAttributes, void 0, r) || {}, i = t.tr.delete(n.from, n.to), c = i.doc.resolve(n.from).blockRange(), l = c && Ln(c, e.type, o);
      if (!l)
        return null;
      ...
      u && u.type === e.type && zt(i.doc, n.from - 1) && (!e.joinPredicate || e.joinPredicate(r, u)) && i.join(n.from - 1);
    }
  });
}
class _ {
...
class qs {
   ...
   */
  ignoreMutation(t) {
    return !this.dom || !this.contentDOM ? !0 : typeof this.options.ignoreMutation == "function" ? this.options.ignoreMutation({ mutation: t }) : this.node.isLeaf || this.node.isAtom ? !0 : t.type === "selection" || this.dom.contains(t.target) && t.type === "childList" && (St() || Ne()) && this.editor.isFocused && [
  ...
  return new Re({
    ...
    handler: ({ state: t, range: n, match: r, pasteEvent: s }) => {
      ...
      if (a) {
        ...
        if (Xt(n.from, n.to, t.doc).filter((m) => m.mark.type.excluded.find((g) => g === e.type && g !== m.mark.type)).filter((m) => m.to > d).length)
          return null;
...
function Qs() {
  return fe || (fe = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function p(v, b, w) {
      ...
      return c(function() {
        L.value = k, L.getSnapshot = b, h(L) && A({
          inst: L
        });
      }, [v, k, b]), a(function() {
        h(L) && A({
...
function eo() {
  ...
  return {
    ...
    setRenderer(n, r) {
      t = {
        ...t,
        [n]: tr.createPortal(r.reactElement, r.element, n)
      }, e.forEach((s) => s());
    },
    /**
...
class Qt {
   ...
   */
  onRender(t) {
    return () => (this.isComponentMounted = !0, clearTimeout(this.scheduledDestructionTimeout), this.editor && !this.editor.isDestroyed && t.length === 0 ? Qt.compareOptions(this.options.current, this.editor.options) || this.editor.setOptions({
      ...this.options.current,
...
class yo {
  ...
  constructor(t, { editor: n, props: r = {}, as: s = "div", className: o = "" }) {
    this.ref = null, this.id = Math.floor(Math.random() * 4294967295).toString(), this.component = t, this.editor = n, this.props = r, this.element = document.createElement(s), this.element.classList.add("react-renderer"), o && this.element.classList.add(...o.split(" ")), this.editor.isInitialized ? er(() => {
      this.render();
    }) : this.render();
  }
  /**
...
class vo extends qs {
  ...
  mount() {
    ...
    } }, o = this.component, i = O.memo((l) => O.createElement(Ge.Provider, { value: s }, O.createElement(o, l)));
...
`));
  ...
  addInputRules() {
    return this.options.levels.map((e) => Dt({
  ...
  addInputRules() {
    ...
    return (this.options.keepMarks || this.options.keepAttributes) && (e = et({
      ...
      getAttributes: () => this.editor.getAttributes(ve),
      editor: this.editor
    })), [
      e
    ];
...
function Fo(e) {
  return new H({
    ...
    appendTransaction: (t, n, r) => {
      ...
      if (!s || o)
        return;
      const { tr: i } = r, a = is(n.doc, [...t]);
      if (hs(a).forEach(({ newRange: l }) => {
        const u = ls(r.doc, l, (h) => h.isTextblock);
        let d, p;
        if (u.length > 1 ? (d = u[0], p = r.doc.textBetween(d.pos, d.pos + d.node.nodeSize, void 0, " ")) : u.length && r.doc.textBetween(l.from, l.to, " ", " ").endsWith(" ") && (d = u[0], p = r.doc.textBetween(d.pos, l.to, void 0, " ")), d && p) {
          ...
          g.filter((y) => y.isLink).map((y) => ({
            ...
            Xt(y.from, y.to, r.doc).some((M) => M.mark.type === e.type) || i.addMark(y.from, y.to, e.type.create({
              href: y.href
            }));
          });
        }
    ...
    props: {
      handleClick: (t, n, r) => {
        ...
        if (!a.find((p) => p.nodeName === "A"))
          return !1;
        const c = Ve(t.state, e.type.name), l = r.target, u = (s = l == null ? void 0 : l.href) !== null && s !== void 0 ? s : c.href, d = (o = l == null ? void 0 : l.target) !== null && o !== void 0 ? o : c.target;
  ...
  return new H({
    ...
    props: {
      handlePaste: (t, n, r) => {
        ...
        const c = Ce(a, { defaultProtocol: e.defaultProtocol }).find((l) => l.isLink && l.value === a);
...
const Li = N.create({
    ...
    return [
      W({
        find: (e) => {
          const t = [];
          if (e) {
            const { protocols: n, defaultProtocol: r } = this.options, s = Ce(e).filter((o) => o.isLink && this.options.isAllowedUri(o.value, {
  ...
  addCommands() {
    return {
      undo: () => ({ state: e, dispatch: t }) => In(e, t),
  ...
  const f = d == null ? void 0 : d(), g = new H({
    ...
    view() {
      return {
        update: async (y, M) => {
          var v, b, w, k, T, x, L;
          const A = (v = this.key) === null || v === void 0 ? void 0 : v.getState(M), I = (b = this.key) === null || b === void 0 ? void 0 : b.getState(y.state), B = A.active && I.active && A.range.from !== I.range.from, Y = !A.active && I.active, X = A.active && !I.active, nt = !Y && !X && A.query !== I.query, j = Y || B && nt, z = nt || B, Tt = X || B && nt;
          if (!j && !z && !Tt)
            return;
          const Q = Tt && !j ? A : I, Zt = y.dom.querySelector(`[data-decoration-id="${Q.decorationId}"]`);
          m = {
            editor: t,
            range: Q.range,
            query: Q.query,
            ...
            clientRect: Zt ? () => {
              var rt;
              const { decorationId: Ye } = (rt = this.key) === null || rt === void 0 ? void 0 : rt.getState(t.state), Ct = y.dom.querySelector(`[data-decoration-id="${Ye}"]`);
            ...
            editor: t,
            query: Q.query
          })), Tt && ((T = f == null ? void 0 : f.onExit) === null || T === void 0 || T.call(f, m)), z && ((x = f == null ? void 0 : f.onUpdate) === null || x === void 0 || x.call(f, m)), j && ((L = f == null ? void 0 : f.onStart) === null || L === void 0 || L.call(f, m));
        },
        destroy: () => {
          var y;
    ...
    state: {
      ...
      apply(y, M, v, b) {
        const { isEditable: w } = t, { composing: k } = t.view, { selection: T } = y, { empty: x, from: L } = T, A = { ...M };
        if (A.composing = k, w && (x || t.view.composing)) {
          (L < M.range.from || L > M.range.to) && !k && !M.composing && (A.active = !1);
          const I = h({
            char: n,
            allowSpaces: r,
    ...
    for (let d = 0, p = 0; d < u.childCount; d += 1) {
      ...
      for (let f = 0; f < h; f += 1, p += 1) {
        ...
        if (a += g || r, g || (c = !1), l) {
          ...
          const M = document.createElement("col"), [v, b] = Ft(r, g);
...
class Jo {
  ...
  update(t) {
    return t.type !== this.node.type ? !1 : (this.node = t, ke(t, this.colgroup, this.table, this.cellMinWidth), !0);
  }
  ignoreMutation(t) {
...
const ct = ({ editor: e }) => {
  ...
  addCommands() {
    return {
      ...
      addColumnBefore: () => ({ state: e, dispatch: t }) => Yn(e, t),
      addColumnAfter: () => ({ state: e, dispatch: t }) => Jn(e, t),
      deleteColumn: () => ({ state: e, dispatch: t }) => Gn(e, t),
      addRowBefore: () => ({ state: e, dispatch: t }) => qn(e, t),
      addRowAfter: () => ({ state: e, dispatch: t }) => Un(e, t),
      deleteRow: () => ({ state: e, dispatch: t }) => Kn(e, t),
      deleteTable: () => ({ state: e, dispatch: t }) => Wn(e, t),
      mergeCells: () => ({ state: e, dispatch: t }) => re(e, t),
      splitCell: () => ({ state: e, dispatch: t }) => se(e, t),
      toggleHeaderColumn: () => ({ state: e, dispatch: t }) => oe("column")(e, t),
      toggleHeaderRow: () => ({ state: e, dispatch: t }) => oe("row")(e, t),
      toggleHeaderCell: () => ({ state: e, dispatch: t }) => Vn(e, t),
      mergeOrSplit: () => ({ state: e, dispatch: t }) => re(e, t) ? !0 : se(e, t),
      setCellAttribute: (e, t) => ({ state: n, dispatch: r }) => zn(e, t)(n, r),
      goToNextCell: () => ({ state: e, dispatch: t }) => ne(1)(e, t),
      goToPreviousCell: () => ({ state: e, dispatch: t }) => ne(-1)(e, t),
      fixTables: () => ({ state: e, dispatch: t }) => (t && Fn(e), !0),
      setCellSelection: (e) => ({ tr: t, dispatch: n }) => {
        if (n) {
          const r = xe.create(t.doc, e.anchorCell, e.headCell);
          t.setSelection(r);
        }
        return !0;
      }
...
//# sourceMappingURL=tiptap-BV9BUpUC.js.map
